...
# def inpaint_image(background,inpainting, mask):
#     assert == inpainting.shape
#     background[mask==0] = inpainting
...
if __name__ == '__main__':
    ...
    app.prepare(ctx_id= 0, det_thresh=DET_CONF, det_size=(640,640),mode=mode)

    with torch.no_grad():
        pic_a = opt.pic_a_path

        img_a_whole = cv2.imread(pic_a)
        #print('img_a_whole shape:', img_a_whole.shape)
